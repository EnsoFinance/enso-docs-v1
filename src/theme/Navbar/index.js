    ...
    <div className="navbar-sidebar">
      ...
      >
        <div className="navbar-sidebar__item menu">
          ...
          <a href="https://www.enso.finance/" target="_blank" rel="noopener noreferrer">
            <p className={styles.ensoCoText}>Use Enso -&gt; </p>
          </a>
          <a
            href="https://github.com/EnsoFinance/enso-docs"
            target="_blank"
        ...
        {!mobileSidebar.shouldRender && (
          <>
            <div className="navbar__items navbar__items--right">
              ...
              <a href="https://www.enso.finance/" target="_blank" rel="noopener noreferrer">
                <button className={styles.ensoCoButton}>Use Enso -&gt;</button>
              </a>
            </div>
          </>
        )}
