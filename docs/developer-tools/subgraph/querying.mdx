...
You can play around with the Enso Subgraph using The Graph's online [sandbox](https://thegraph.com/explorer/subgraph/EnsoFinance/enso-v1).

To programmatically query the Enso Subgraph you can send queries to:

`https://api.thegraph.com/subgraphs/name/EnsoFinance/enso-v1`

## Enso NFT Queries (Media)

---

NFTs minted on Enso (zNFTs) are also referred to as `media` in the subgraph
